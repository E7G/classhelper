              ...
              Consumer<QuestionProvider>(
                builder: (context, questionProvider, _) {
                  return Column(
                    children: [
                      SwitchListTile(
                        title: const Text('自动检测问题'),
                        subtitle: const Text('ASR识别到问题时自动调用AI回答'),
                        value: questionProvider.autoDetectEnabled,
                        onChanged: (value) {
                          questionProvider.setAutoDetectEnabled(value);
                        },
                      ),
                      if (questionProvider.autoDetectEnabled) ...[
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                questionProvider.autoDetectConfidenceThreshold <= 0.4
                                    ? '高'
                                    : questionProvider.autoDetectConfidenceThreshold <= 0.7
                                        ? '中'
                                        : '低',
                        ...
                        Padding(
                          ...
                          child: Slider(
                            value: questionProvider.autoDetectConfidenceThreshold,
                            min: 0.3,
                            max: 1.0,
                            divisions: 7,
                            label: questionProvider.autoDetectConfidenceThreshold.toStringAsFixed(1),
                            onChanged: (value) {
                              questionProvider.setAutoDetectConfidenceThreshold(value);
                            },
                          ),
                        ),
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 16),
                          child: Text(
                            '灵敏度越高，越容易将普通语句识别为问题；灵敏度越低，只检测明确的问题句式',
                            style: Theme.of(context).textTheme.bodySmall?.copyWith(
